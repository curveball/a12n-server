...
/**
 * This schema represents the information displayed on the home page of a12n-server.
 */
export interface Home {
  ...
  /**
   * The version of the a12n-server package.
   */
  version: string;
  stats: ServerStats;
}
...
export interface ServerStats {
  /**
   * The statistics about the server.
   */
  stats: {
    /**
...
/**
 * This object contains statistics about the server.
 */
export interface ServerStats {
  /**
   * The statistics about the server.
...
/**
 * This object is used to validate the correctness of a verification code.
 */
